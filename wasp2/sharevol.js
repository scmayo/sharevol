...
!0)))}},"Update"),a.add({loadFile:function(){document.getElementById("fileupload").click()}},"loadFile").name("Load Image file"),a.add({ColourMaps:function(){window.colourmaps.toggle()}},"ColourMaps"),volume&&volume.addGUI(a));window.onbeforeunload=saveData}function fileSelected(a){filesProcess(a)}
