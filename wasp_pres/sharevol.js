...
function Volume(a,b,c,d){this.image=b;this.canvas=document.createElement("canvas");this.canvas.style.cssText="width: 600px; height: 600px; z-index: 0; margin: 20px; padding: 0px; background: black; border: none; display:block;";d||(d=document.body);d.appendChild(this.canvas);this.canvas.mouse=new Mouse(this.canvas,this);this.canvas.mouse.moveUpdate=!0;this.background=new Colour(4282400832);this.borderColour=new Colour(4290493371);this.width=this.height=0;this.webgl=new WebGL(this.canvas);this.gl=this.webgl.gl;
