...
this.container=document.createElement("div");this.container.style.cssText="position: absolute; bottom: 10px; left: 10px; margin: 0px; padding: 0px; pointer-events: none;";d||(d=document.body);d.appendChild(this.container);a.slicer&&this.load(a.slicer);this.canvas=document.createElement("canvas");this.canvas.style.cssText="position: relative; bottom: 0px; margin: 0px; padding: 0px; border: none; background: rgba(0,0,0,0); pointer-events: none;";this.doLayout();this.canvas.mouse=new Mouse(this.canvas,
...
function Volume(a,b,c,d){this.image=b;this.canvas=document.createElement("canvas");this.canvas.style.cssText="width: 50%; height: 50%; z-index: 0; margin: 0px; padding: 0px; background: black; border: none; display:block;";d||(d=document.body);d.appendChild(this.canvas);this.canvas.mouse=new Mouse(this.canvas,this);this.canvas.mouse.moveUpdate=!0;this.background=new Colour(4282400832);this.borderColour=new Colour(4290493371);this.width=this.height=0;this.webgl=new WebGL(this.canvas);this.gl=this.webgl.gl;
